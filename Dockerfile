...
# nginx Installation
# https://github.com/nginxinc/docker-nginx/blob/97b65112180e0c7764465aa47a974fc7af3c99ae/mainline/stretch/Dockerfile
...
COPY ./etc/nginx/conf.d/reactapp.conf /etc/nginx/conf.d/default.conf
